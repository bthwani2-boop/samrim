...
**ROOT-CLEAN LOCAL EXECUTION LAW:** In `LOCAL DEVELOPMENT`, there is no technical preservation bias: when the correct treatment requires deletion, cleanup, restructuring, refoundation, remodeling, regeneration, re-migration, rebuilding or full replacement inside the authorized material cone, execute it completely rather than preserving legacy merely to avoid change. The non-negotiable target is proven 100% closure of the authorized material scope on the cleanest canonical truth; treat the highest causal root, complete every cutover, delete every losing path and residue, and leave no patch, shadow truth or unjustified compatibility. Preserve only work/data/history with a proven current preservation, authority or safety obligation.
