...
Central catalog/taxonomy identity is authoritative. Partner/store surfaces may manage owner-authorized commercial/store associations and availability under the catalog contract; they do not fork category/product identity.

## Partner team and authorization

Partner users act through explicit organization/store scopes and permissions. Membership does not grant unrestricted access to every store or financial action.
