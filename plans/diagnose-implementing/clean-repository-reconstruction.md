...
| Product Truth spec/schema/contracts | `PRD.md`, `CAPABILITIES.md`, `JOURNEYS.md`, domain models/policies | MERGE/REFINE | PARTIAL_PER_CAPABILITY |
...
| historical `99-SOURCE-MAP.md` semantic accounting | donor extraction template + this temporary plan | GENERALIZE/REHOME | PARTIAL |
