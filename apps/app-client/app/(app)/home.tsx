...
export default function ClientHomeRoute() {
  ...
  return <ClientScrollScreen><StoreDiscovery isAuthenticated={isAuthenticated} onRequireAuthentication={!isAuthenticated ? () => router.replace("/?returnTo=/home" as Href) : undefined} /></ClientScrollScreen>;
}
