...
export function NotificationsInbox() {
  ...
  return (
    <View style={styles.container} accessibilityLabel="إشعارات العميل">
      <View style={styles.screenHeader}>
        <View style={styles.headingCopy}>
          <Text style={styles.eyebrow}>مركز التنبيهات</Text>
          <Text style={styles.title}>الإشعارات</Text>
          <Text style={styles.description}>تابع آخر تحديثات طلباتك في قائمة واضحة ومنظمة.</Text>
        </View>
      ...
      {!authenticated ? (
        <BthwaniSurface tone="inset" style={styles.state}>
          ...
          <Text style={styles.cardTitle}>سجّل الدخول لقراءة إشعارات طلباتك</Text>
          <Text style={styles.muted}>ستظهر هنا تحديثات الطلبات بعد تسجيل الدخول.</Text>
        ...
        <>
          <BthwaniSurface tone="raised" style={styles.summary}>
            ...
            <View style={styles.summaryCopy}>
              ...
              <Text style={styles.muted}>{unreadCount ? "ابدأ بالأحدث لتبقى على اطلاع." : "أنت على اطلاع بكل تحديثاتك."}</Text>
            </View>
          </BthwaniSurface>
