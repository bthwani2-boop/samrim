...
function createStyles(theme: ReturnType<typeof resolveTheme>) {
  return StyleSheet.create({
    ...
    provider: { backgroundColor: theme.background, width: "100%", direction: "rtl" },
    scopeHeader: { alignItems: "center", backgroundColor: theme.surface, borderColor: theme.borderColor, borderRadius: 12, borderWidth: 1, flexDirection: "row", justifyContent: "space-between", margin: 12, paddingHorizontal: 12, paddingVertical: 10 },
    scopeLabel: { color: theme.structure, fontSize: 13, fontWeight: "700" },
    ...
    cityName: { color: theme.structure, fontSize: 17, fontWeight: "800", textAlign: "right" },
    cityMeta: { color: theme.colorMuted, fontSize: 12, textAlign: "right" },
