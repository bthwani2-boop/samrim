...
const navigation = [
  { href: "/home", label: "الرئيسية", accessibilityLabel: "جاهزية الكابتن" },
  { href: "/offers", label: "العروض", accessibilityLabel: "عروض التوصيل" },
  { href: "/deliveries", label: "التوصيلات", accessibilityLabel: "التوصيلات الحالية" },
  { href: "/account", label: "الحساب", accessibilityLabel: "حساب الكابتن" },
] as const;
...
function createStyles(theme: ReturnType<typeof resolveTheme>) {
  ...
  return StyleSheet.create({
    ...
    content: { flex: 1 }, screenContent: { flexGrow: 1, paddingBottom: 24 },
    navigation: { backgroundColor: theme.surface, borderTopColor: theme.borderColor, borderTopWidth: 1, flexDirection: rowDirection, gap: spacing[1], justifyContent: "space-around", paddingHorizontal: spacing[2], paddingVertical: spacing[2] },
    navigationItem: { alignItems: "center", borderRadius: radius.md, flex: 1, justifyContent: "center", minHeight: sizing.controlLg, paddingHorizontal: spacing[1] }, navigationItemSelected: { backgroundColor: theme.actionSoft }, navigationItemPressed: { opacity: 0.72 },
    navigationLabel: { color: theme.colorMuted, fontSize: typography.caption.fontSize, fontWeight: "700", textAlign: "center" }, navigationLabelSelected: { color: theme.interactiveText },
  });
}
