...
export function CaptainHeader({ styles }: { styles: ReturnType<typeof createStyles> }) {
...
function createStyles(theme: ReturnType<typeof resolveTheme>) {
  ...
  return StyleSheet.create({
    ...
    navigation: { backgroundColor: theme.surface, borderTopColor: theme.borderColor, borderTopWidth: 1, direction: activeDirection, flexDirection: rowDirection, paddingHorizontal: spacing[2], paddingVertical: spacing[2] },
