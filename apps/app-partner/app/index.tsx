...
export default function IdentityGate() {
  return <ManagedIdentityGate roleLabel="الشريك" readState={readManagedAuthState} requestCode={requestManagedActivation} requestRecovery={requestManagedRecovery} recover={recoverManagedIdentity} login={loginManagedIdentity} activate={activateManagedIdentity} restore={restoreIdentitySession} currentState={currentIdentityState} logout={logoutIdentity} />;
}
