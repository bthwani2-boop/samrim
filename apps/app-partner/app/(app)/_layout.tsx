...
import PartnerShell from "../../src/shell/partner-shell";
...
export default function PartnerAppLayout() {
  ...
  return <AuthenticatedMobileBoundary binding={identity} onUnauthenticated={onUnauthenticated}><PartnerShell /></AuthenticatedMobileBoundary>;
}
