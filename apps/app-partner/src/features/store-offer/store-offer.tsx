...
function createStyles(theme: ReturnType<typeof resolveTheme>) {
  ...
  return StyleSheet.create({
    ...
    offerPicker: { gap: 6 },
    input: { backgroundColor: theme.surface, borderColor: theme.borderColor, borderRadius: 10, borderWidth: 1, color: theme.color, flex: 1, minHeight: 44, paddingHorizontal: 10, textAlign: startTextAlign, writingDirection: activeDirection },
    productList: { gap: 8 },
