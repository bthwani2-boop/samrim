...
type PayoutState = Readonly<{ state: { actorType: ActorType; actorId: string; eligibleAvailableMinor: number; heldMinor: number; destination: Destination | null; latestPayout: { id: string; resolvedAmountMinor: number; status: string; ledgerTransactionId?: string } | null } }>;
