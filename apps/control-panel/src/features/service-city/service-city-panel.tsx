...
export function ServiceCityPanel() {
  ...
  async function create() {
    ...
    try {
      ...
      setDisplayNameAr("");
      setNotice(`تم حفظ المدينة الكانونية. المعرف التلقائي: ${result.city.id}`);
      await load();
    } catch {
