import { identityErrorPayload, identityHttpStatus, requestOperatorEnrollment } from "../../../../../src/server/identity/identity-bff";
...
export async function POST(request: Request) {
  try {
    ...
    const challenge = await requestOperatorEnrollment(body.phone, body.operatorEnrollmentToken);
