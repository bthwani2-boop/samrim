...
var requiredTables = []struct {
	...
	{name: "dsh.captain_admissions", columns: []string{"id", "actor_id", "contact_phone_e164", "state", "availability_state", "version", "created_at", "updated_at"}, constraints: []string{"captain_admissions_pkey", "captain_admissions_actor_id_key", "captain_admissions_state_chk", "captain_admissions_availability_chk", "captain_admissions_version_chk", "captain_admissions_phone_chk", "captain_admissions_identity_state_chk", "captain_admissions_pending_availability_chk"}, indexes: []string{"captain_admissions_pending_phone_uq", "captain_admissions_dispatch_idx"}},
