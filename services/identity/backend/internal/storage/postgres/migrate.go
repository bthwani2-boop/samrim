...
var identitySchemaRequirements = []schemaRequirement{
	...
	{table: "identity_refresh_token_history", columns: []string{"session_id", "token_hash", "rotated_at", "refresh_request_id"}, indexes: []string{"identity_refresh_token_history_pkey", "identity_refresh_token_history_hash_uq", "identity_refresh_token_history_session_idx", "identity_refresh_token_history_request_id_uq"}},
