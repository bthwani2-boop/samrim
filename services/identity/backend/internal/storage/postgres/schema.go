...
var identitySchemaConstraints = []schemaConstraint{
	...
	{table: "identity_operator_permissions", name: "identity_operator_permissions_permission_chk", definition: "CHECK (((permission)::text = ANY ((ARRAY['finance'::character varying, 'platform_policies'::character varying])::text[])))", critical: true},
