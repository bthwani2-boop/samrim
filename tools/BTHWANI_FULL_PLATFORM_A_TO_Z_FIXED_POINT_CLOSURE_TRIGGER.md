...
# 6. DONOR AND HISTORY EVIDENCE

استخدم الأدلة التاريخية المحفوظة أولًا، وافحص فقط الجزء القادر على تغيير القرار الحالي. ثبّت المصدر والمرجع وSHA عند الحاجة المادية إلى تحقق حي، وتعامل مع تاريخ التنفيذ بوصفه دليلًا فقط لا مصدرًا لمعنى المنتج أو ملكية النظام.
