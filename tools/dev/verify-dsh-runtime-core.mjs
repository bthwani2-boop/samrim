...
const directFieldReenrollment = await request(identityBase, "POST", `/internal/actors/${encodeURIComponent(fieldActorID)}/roles/field/reenrollment`, { token: dshToken, headers: { ...fieldReenrollmentHeaders, "X-Expected-Actor-Version": String(fieldReenrollmentBody.expectedActorVersion), "X-Reason": fieldReenrollmentBody.reason } });
