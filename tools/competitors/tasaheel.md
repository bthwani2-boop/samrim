...
- Local-only directory: `./local-photos/tasaheel/`
...
```markdown
[Home / Discovery](./local-photos/tasaheel/home-discovery.png)
[Store details](./local-photos/tasaheel/store-details.png)
[Product details](./local-photos/tasaheel/product-details.png)
[Cart](./local-photos/tasaheel/cart.png)
[Checkout](./local-photos/tasaheel/checkout-01-summary.png)
[Order tracking](./local-photos/tasaheel/order-tracking.png)
```
