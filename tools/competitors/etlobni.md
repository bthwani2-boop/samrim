...
- Local-only directory: `./local-photos/etlobni/`
...
```markdown
[Home / Discovery](./local-photos/etlobni/home-discovery.png)
[Store details](./local-photos/etlobni/store-details.png)
[Product details](./local-photos/etlobni/product-details.png)
[Cart](./local-photos/etlobni/cart.png)
[Checkout](./local-photos/etlobni/checkout-01-summary.png)
[Order tracking](./local-photos/etlobni/order-tracking.png)
```
