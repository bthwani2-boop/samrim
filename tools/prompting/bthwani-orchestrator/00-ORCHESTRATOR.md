...
```text
FOUNDATION_CONSTRUCTION_PROFILE_REQUIRED_WHEN_APPLICABLE
FOUNDATION_EXIT_TOKEN = FOUNDATION_CONSTRUCTION_EXIT_GATE
FOUNDATION_EXIT_CLAIM = STRUCTURAL_FOUNDATION_READY_ONLY
PROTECTED_JOURNEY_READY_REQUIRES_STAGE_B_PREREQUISITE_CLOSURE
```
